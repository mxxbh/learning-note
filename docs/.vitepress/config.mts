    ...
    sidebar: {
      ...
      "/功能开发/": [
        ...
        },
        {
          text: "浏览器问题",
          collapsed: false,
          items: [{ text: "ES Module 语法不支持", link: "/功能开发/浏览器问题/ES Module 语法不支持" }],
        },
        {
          text: "移动端问题",
          collapsed: false,
          items: [
            { text: "调试", link: "/功能开发/移动端问题/调试" },
            { text: "内容显示在安全区域", link: "/功能开发/移动端问题/内容显示在安全区域" },
            { text: "内容横屏显示", link: "/功能开发/移动端问题/内容横屏显示" },
            { text: "禁用默认触控", link: "/功能开发/移动端问题/禁用默认触控" },
            { text: "按钮异常高亮", link: "/功能开发/移动端问题/按钮异常高亮" },
            { text: "滚动条无法正常滚动", link: "/功能开发/移动端问题/滚动条无法正常滚动" },
            { text: "视频播放默认全屏", link: "/功能开发/移动端问题/视频播放默认全屏" },
            { text: "视频无法自动播放", link: "/功能开发/移动端问题/视频无法自动播放" },
            { text: "视频遮挡其他元素", link: "/功能开发/移动端问题/视频遮挡其他元素" },
          ],
        },
      ],
      "/其他/计算机科学与技术/": [
